...
public class DescriptionFragment extends Fragment {
    ...
    private void initDatePiker(){
        ...
        datePickerDialog = new DatePickerDialog(binding.getRoot().getContext(), style, dateSetListener, cal.get(Calendar.YEAR), cal.get(Calendar.MONTH) + 1, cal.get(Calendar.DAY_OF_MONTH));
